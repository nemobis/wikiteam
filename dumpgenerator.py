            ...
            for title in readTitles(config):
                ...
                for page in pages:
                    try:
                        ...
                        logerror(
                            config=config,
                            text='Error: empty revision from API. Could not export page: %s' % (title.decode('utf-8'))
                        )
                        continue
                    yield xml
    ...
    if oldAPI:
        ...
        while gapfrom:
            ...
            if 'query' in jsonimages:
                ...
                for image, props in list(jsonimages['query']['pages'].items()):
